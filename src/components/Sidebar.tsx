...
export const Sidebar = (props: { user: any; logoutHandler: any; changePage: any; page: any; }) => {
...
export const ClientMenu = (props: { changePage: any; logoutHandler: any; page: any; }) => {
...
export const SideMenu = (props: { changePage: any; logoutHandler: any; page: any; }) => {
    const {changePage, logoutHandler, page} = props;
    return (
        <ul>
            <SideLink onClickHandler={changePage} active={page} page="home" icon="bx bx-home" text="Home" />
...
export const SideLink = (props: { onClickHandler?: any; icon?: any; text?: any; page?: any; active?: any; }) => {
    const {icon, text, page, active} = props;
    
    function clickLink(event: { preventDefault: () => void; }) {
        if(page) {
